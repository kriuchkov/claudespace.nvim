...
local function build(dir)
  ...
  add('')
  add('  ⬡ workspace', 'CSWorkspace')
  add('  AI-native workspace for Claude', 'CSInfo')
  add('')
...
function M.open(dir)
  ...
  vim.keymap.set('n', '\\',   function() require('workspace.filetree').open(dir) end, o)
  vim.keymap.set('n', '<CR>', function() require('workspace.filetree').open(dir) end, o)
